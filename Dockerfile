...
RUN (mkdir -p /build/flux-mail-api/libs/flux-autoload-api && cd /build/flux-mail-api/libs/flux-autoload-api && wget -O - https://github.com/fluxfw/flux-autoload-api/releases/download/v2022-07-12-1/flux-autoload-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxAutoloadApi FluxMailApi\\Libs\\FluxAutoloadApi)
